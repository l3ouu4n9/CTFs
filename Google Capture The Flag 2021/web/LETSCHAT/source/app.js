...
class App {
  ...
  emptyRoom() {
    ...
    $("#chat").html("<p>Create a room and invite your friends!<p>Or ask your friends to invite you to their room and Join it</p><p>Don't have any friends? No worries! Everyone can join the 'public' room!</p>");
  }
